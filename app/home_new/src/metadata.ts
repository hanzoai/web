...
export default {
  ...
  title: {
    default: 'Hanzo Blank',
    template: '%s | Hanzo Blank',
  },
  description: 'Explore your swaps',
  applicationName: 'Hanzo Bridge Explorer',
  authors: {name: 'Hanzo Dev team'},
  keywords: "Hanzo Network, Blockchain Bridge, Multi-Chain, EVM, Solana, Bitcoin, Cross-Chain, Interoperability, Cryptocurrency, Blockchain Technology",
  icons: [
    {
      rel: 'icon',
      type: 'image/png',
  ...
  /*
  openGraph: {
    title: 'Hanzo Bridge Explorer - Explore your swaps',
