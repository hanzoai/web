...
const DashTextCard: FC<TextCardDataProps> = (props) => {
  ...
  return (
    <div className="flex flex-row rounded-lg border border-level-1 shadow bg-background text-primary p-5 justify-between">
      ...
      <div className="flex border border-level-1 rounded-md p-[6px] h-9 w-9 items-center justify-center">
        {cardIcon} 
      </div>
    </div>
  )
