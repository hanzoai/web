    ...
    <div className="flex-1 space-y-4 p-8 pt-6 overflow-y-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        <div className="w-full lg:flex-[60%] gap-4 flex flex-col bg-background shadow">
          <div className="flex flex-col w-full rounded-md border border-[#AAAAAA33] bg-background shadow p-4 gap-8">
          ...
          <div className="flex flex-col w-full rounded-md border border-[#AAAAAA33] bg-background shadow p-4 gap-4">
        ...
        <div className="w-full h-fit lg:flex-[40%] flex flex-col rounded-md border border-[#AAAAAA33] shadow p-4 text-muted-1 text-base font-medium gap-8">
