...
export default function Impact() {
    ...
    const impactRef = useRef() as RefObject<HTMLDivElement>
    ...
    return (
        <div id='impact' className='w-full h-full pt-20'>
            <div ref={impactRef} className={cn("border-t-2 lg:flex 2xl:pt-8 lg:pt-4 pt-8 mt-8 2xl:mb-19 lg:mb-10 mb-19", titleAnim)}>
