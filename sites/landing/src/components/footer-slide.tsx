...
const FooterSlide: React.FC<{
  ...
  agent
    ...
    <div className='snap-start snap-always h-full swipe flex flex-col justify-between items-stretch gap-3 w-full pt-20'>
      <div className='flex flex-col md:px-4 gap-10 md:gap-20 justify-start'>
