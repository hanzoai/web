      ...
      <div className={cn(
        ...
        <div className='lg:flex lg:flex-col lg:h-full lg:items-center lg:justify-around px-4 hidden'>
          <div className='flex'>
            ...
            <div className='px-5 text-[32px] font-light text-xl leading-8'>We're dedicated to advancing technology with a focus on impactful, global change. At Hanzo, we see the transformative potential in every business—that's why we're here to enhance your solutions and extend your reach.</div>
          </div>
          <div className='flex justify-around pt-8 mb-19 w-full mt-[10px] mt-[30px]'>
