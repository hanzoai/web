        ...
        element :(
          <div className='flex flex-col items-center justify-center w-full'>
            ...
            <div className='flex flex-col sm:flex-row mt-21 gap-10 md:gap-16'>
              <Button variant={'outline'} rounded={'none'} className= 'w-52 md:w-96 h-15 md:h-20 text-base md:text-2xl'>
                BROWSE CASE STUDIES
              </Button>
              <Button variant={'primary'} rounded={'none'} className='w-52 md:w-96 h-15 md:h-20 text-base md:text-2xl'>
                SCHEDULE CALL
              </Button>
            </div>
          </div>
