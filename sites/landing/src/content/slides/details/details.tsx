...
export default {
  ...
  explain1: [
    "With over a decade of experience and backed by Techstars, Hanzo has a proven track record of transforming the complexities of modern business into streamlined success stories.",
