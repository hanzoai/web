...
export {default as isAsyncFunction}     from './async-function'
...
export {default as isGeneratorFunction} from './generator-function'
export {default as isGenerator}         from './generator'
