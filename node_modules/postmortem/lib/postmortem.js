...
exports.mapEvalOrigin = function(origin) {
  ...
  if (match = /^eval at ([^(]+) \((.+)\)$/.exec(origin)) {
    return `eval at ${match[1]} (${exports.mapEvalOrigin(match[2])})`;
  }
  return origin;
};
...
var wrap = function(err, frame) {
  ...
  if (origin) {
    origin = exports.mapEvalOrigin(origin);
    _frame = clone(frame);
...
exports.callsite = index;
exports.coffee = coffee;
exports.install = install;
exports.mapSourcePosition = sourceMapSupport.mapSourcePosition;
exports.structuredStackTrace = structured;
exports.utils = utils;
