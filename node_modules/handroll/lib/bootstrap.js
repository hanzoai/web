...
var executable = _interopDefault(require('rollup-plugin-executable'));
...
var coffee2 = _interopDefault(require('rollup-plugin-coffee2'));
...
var banner = function() {
  if (banner.seen == null) {
    log$1.white.dim("handroll v" + version + " 🍣");
...
render = function(filename, size, gzipSize) {
  ...
  gb = chalk.green.bold;
  wb = chalk.white.bold;
  return " ⇢ " + (wb(filename)) + "\t" + (gb(size)) + " (" + (gb(gzipSize)) + " compressed)";
};
...
var autoCompilers = function(opts) {
  ...
  coffeeOpts = Object.assign({}, (ref = opts.compilers) != null ? ref.coffee : void 0);
  typescriptOpts = Object.assign({}, (ref1 = opts.compilers) != null ? ref1.typescript : void 0);
  jsonOpts = Object.assign({}, (ref2 = opts.compilers) != null ? ref2.json : void 0);
...
var autoPlugins = function(opts) {
  ...
  if ((opts.minify != null) && !opts.minify === false) {
    plugins.push(minify(Object.assign({}, {
      sourceMap: opts.sourceMap
    }, opts.minify)));
  }
  if (!opts.quiet) {
...
var writeAll = function(bundle, opts) {
  ...
  for (i = 0, len = ref.length; i < len; i++) {
    fmt = ref[i];
    ps.push(write(bundle, Object.assign({}, opts, {
      format: fmt
    })));
  }
